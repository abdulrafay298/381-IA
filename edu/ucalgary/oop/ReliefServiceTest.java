...
public class ReliefServiceTest {
    ...
    private String expectedLogDetails = "Inquirer: John, Missing Person: John Dalan, Date of Inquiry: 2024-02-10, Info Provided: Looking for family member, Last Known Location: University of Calgary"; 
    ...
    public void setUp() {
        ...
        missingPerson = new DisasterVictim("John", "Dalan", "2024-01-19", "", 123, "2024-01-19");
